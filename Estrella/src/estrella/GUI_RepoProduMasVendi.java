...
public class GUI_RepoProduMasVendi extends javax.swing.JFrame {

    public static String campo = "";
    public static String Id_guardado = "";

    public GUI_RepoProduMasVendi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        PanelRepoPMV = new javax.swing.JPanel();
        ...
        PanelRepoPMV.setBackground(new java.awt.Color(248, 248, 248));
        PanelRepoPMV.setPreferredSize(new java.awt.Dimension(1050, 600));
        PanelRepoPMV.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Titulo.setFont(new java.awt.Font("Microsoft JhengHei", 1, 30)); // NOI18N
        Titulo.setForeground(new java.awt.Color(0, 0, 0));
        Titulo.setText("Reporte de Costos");
        PanelRepoPMV.add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, -1, -1));

        LineaDivisora.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Linea001.png"))); // NOI18N
        PanelRepoPMV.add(LineaDivisora, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 870, 20));
        ...
        PanelRepoPMV.add(BtnBuscarProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, -1, -1));
        ...
        PanelRepoPMV.add(BuscarProdu, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 170, -1));

        FondoText10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Search Bar.png"))); // NOI18N
        PanelRepoPMV.add(FondoText10, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, -1, -1));
        ...
        PanelRepoPMV.add(LabelBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, -1, -1));

        jLabel3.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Buscar por:");
        PanelRepoPMV.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 130, -1, -1));
        ...
        PanelRepoPMV.add(comboBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 130, -1, -1));
        ...
        PanelRepoPMV.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, 880, 250));
        ...
        PanelRepoPMV.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 460, -1, -1));
        ...
        PanelRepoPMV.add(CampoGuarda_IdProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 510, 180, -1));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(PanelRepoPMV, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        GUI_RepoProduMasVendi ventanaRepoPMV = new GUI_RepoProduMasVendi();
        ventanaRepoPMV.setBounds(0, 0, 1050, 600);
        ventanaRepoPMV.setVisible(true);
        ventanaRepoPMV.setResizable(false);
        ventanaRepoPMV.setLocationRelativeTo(null);
    ...
    public static javax.swing.JPanel PanelRepoPMV;
