...
public class GuiRegisVentaFiado extends javax.swing.JFrame {
  ...
  PreparedStatement ps4 ;
    ...
    private void initComponents() {
        ...
        PanelRegisVentFia = new javax.swing.JPanel();
        ...
        PanelRegisVentFia.setBackground(new java.awt.Color(248, 248, 248));
        PanelRegisVentFia.setPreferredSize(new java.awt.Dimension(1050, 600));
        PanelRegisVentFia.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        PanelRegisVentFia.add(BtnRegisVent, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 500, 250, 90));
        ...
        PanelRegisVentFia.add(FieldCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 260, 180, -1));
        ...
        PanelRegisVentFia.add(FieldHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 360, 180, -1));
        ...
        PanelRegisVentFia.add(FieldIdCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 270, 180, -1));

        LabelCostoTotal.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 18)); // NOI18N
        LabelCostoTotal.setText("Costo Total");
        PanelRegisVentFia.add(LabelCostoTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, -1, -1));

        LabelHora.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 18)); // NOI18N
        LabelHora.setText("Hora de la Venta");
        PanelRegisVentFia.add(LabelHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 320, -1, -1));

        LabelidCliente.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 18)); // NOI18N
        LabelidCliente.setText("Id Cliente");
        PanelRegisVentFia.add(LabelidCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 230, -1, -1));

        Titulo.setFont(new java.awt.Font("Microsoft JhengHei", 1, 30)); // NOI18N
        Titulo.setText("Registar Venta");
        PanelRegisVentFia.add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, -1, -1));

        LineaDivisora.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Linea001.png"))); // NOI18N
        PanelRegisVentFia.add(LineaDivisora, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 870, 20));

        FondoText3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/CampoDeText.png"))); // NOI18N
        PanelRegisVentFia.add(FondoText3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, -1, -1));

        FondoText4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/CampoDeText.png"))); // NOI18N
        PanelRegisVentFia.add(FondoText4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 350, -1, -1));

        FondoText5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/CampoDeText.png"))); // NOI18N
        PanelRegisVentFia.add(FondoText5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 260, -1, -1));

        LabelFecha.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 18)); // NOI18N
        LabelFecha.setText("Fecha de la Venta");
        PanelRegisVentFia.add(LabelFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 320, -1, -1));
        ...
        PanelRegisVentFia.add(FieldCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 170, 180, -1));

        LabelCantidad.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 18)); // NOI18N
        LabelCantidad.setText("Cantidad");
        PanelRegisVentFia.add(LabelCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 130, -1, -1));

        FondoText7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/CampoDeText.png"))); // NOI18N
        PanelRegisVentFia.add(FondoText7, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 160, -1, -1));
        ...
        PanelRegisVentFia.add(IdProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 160, 180, -1));
        ...
        PanelRegisVentFia.add(estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 490, 180, -1));

        FondoText9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/CampoDeText.png"))); // NOI18N
        PanelRegisVentFia.add(FondoText9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 150, -1, -1));

        LabelCostoTotal1.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 18)); // NOI18N
        LabelCostoTotal1.setText("Id Producto");
        PanelRegisVentFia.add(LabelCostoTotal1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, -1, -1));
        ...
        PanelRegisVentFia.add(IdVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 460, 180, -1));

        FondoText10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/CampoDeText.png"))); // NOI18N
        PanelRegisVentFia.add(FondoText10, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 450, -1, -1));

        LabelidVenta.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 18)); // NOI18N
        LabelidVenta.setText("Id Venta");
        PanelRegisVentFia.add(LabelidVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 420, -1, -1));
        ...
        PanelRegisVentFia.add(FieldFechaDia, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 350, 30, -1));
        ...
        PanelRegisVentFia.add(FieldFechaMes, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 350, 30, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(PanelRegisVentFia, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    public static javax.swing.JPanel PanelRegisVentFia;
