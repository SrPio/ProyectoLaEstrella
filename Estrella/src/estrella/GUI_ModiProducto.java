...
public class GUI_ModiProducto extends javax.swing.JFrame {

    public static String campo = "";

    public GUI_ModiProducto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Labelid_Prod.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LabelConcepto.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LabelPrecioVenta.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LabelFechaAviso.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LabelExistencias.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void BtnModifiProduActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModifiProduActionPerformed
        ...
        if (estado.getText().equals("Activo")) {
            ...
            try {
                ...
                con = getConection();
                ps = con.prepareStatement("UPDATE producto SET nombre_producto=?, concepto=?, costo=?, existencias=?, costo_ponderado=?, precio_venta=?, categoria=?, estado=?, fecha_caducidad=?, fecha_aviso=? WHERE id_producto=?");
