...
public class Guiregisventacontado extends javax.swing.JFrame {

  public Guiregisventacontado() {
    initComponents();
  }
  ...
  @SuppressWarnings("unchecked")
    ...
    try {
      ...
      fecha = (FieldFechaDia.getText() + " - " + FieldFechaMes.getText() 
      ...
      if (nuevaExistencia > 0) {
        ...
        ps = con.prepareStatement("INSERT INTO ventas(codigo, cantidad,"
                        + " costo_total, estado, hora, fecha) VALUES (?,?,?,?,?,?)");
        ...
        JOptionPane.showMessageDialog(null, "La cantidad a vender es mayor que la"
