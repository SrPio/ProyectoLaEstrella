...
public class GuiRegisProducto extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    fechaCaduci = (FieldFechaDia.getText() + " - " 
            + FieldFechaMes.getText() + " - " + FieldFechaAño.getText());
    fechaAviso = (FieldFechaDiaAviso.getText() + " - " 
            + FieldFechaMesAviso.getText() + " - " + FieldFechaAñoAviso.getText());

    Connection con = null;
    try {

      con = getConection();
      ps = con.prepareStatement("INSERT INTO producto(id_producto,"
              + " nombre_producto, concepto, costo, existencias, costo_ponderado, precio_venta,"
